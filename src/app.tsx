        ...
        isGuestsModalOpen && (
          <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
            <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
              ...
              <div className="flex flex-wrap gap-2">
                {
                  emailsToInvite.map(email => {
                    return (
                      <div className="px-2.5 py-1.5 rounded-md bg-zinc-800 flex items-center gap-2" key={email}>
              ...
              <div className="w-full h-px bg-zinc-800 flex items-center">
              </div>
              ...
              <form className="p-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2" onSubmit={addNewEmailToInvite}>
                <div className="px-2 flex items-center flex-1 gap-2">
                  ...
                  <input type="e-mail" placeholder="Digite o e-mail do convidado" name="email" className="bg-transparent text-lg placeholder-zinc-400 outline-none" />
                </div>
